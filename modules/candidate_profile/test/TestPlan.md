...
1.  **Module access permissions**
    - For a candidate of the same site as your user, accessing the candidate_profile module via the url (https://\<yourInstance>\.loris.ca/\<candidateID\>) should not require any permission (With data entry permisson, click on the "Open Profile" button can also lead to the page).
